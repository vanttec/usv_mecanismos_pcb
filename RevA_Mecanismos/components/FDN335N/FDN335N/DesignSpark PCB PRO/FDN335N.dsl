...
(library Library_1
	...
	(patternDef "SOT95P251X112-3N" (originalName "SOT95P251X112-3N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.7 1.46) (pt 0.7 1.46) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.7 1.46) (pt 0.7 -1.46) (width 0.1))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.7 0.51) (pt 0.25 1.46) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "FDN335N" (originalName "FDN335N") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "Datasheet Link" "https://pdf1.alldatasheet.com/datasheet-pdf/view/51379/FAIRCHILD/FDN335N.html")
		(attr "Height" "1.12 mm")
	)
